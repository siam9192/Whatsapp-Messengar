      ...
      <Container>
        <div className=" mx-auto  flex  items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <p className=" font-secondary text-sm hidden md:block">
              Connect your WhatsApp account
            </p>
          </div>
          <div className="flex items-center  gap-6">
            <div className=" px-4 py-2  bg-accent/10 size-fit rounded-full mx-auto border border-accent text-primary font-semibold font-primary hidden lg:flex items-center gap-2 ">
