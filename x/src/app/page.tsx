...
export default function Home() {
  ...
  return (
    <div>
      <Container>
        <div className="max-w-md min-h-160 mx-auto bg-card border-[#FFFFFF1A] p-8  border mt-20 rounded-[32px] card-shadow relative overflow-hidden">
          ...
          <div className="mt-5 px-4 py-2  bg-accent/10 size-fit rounded-full mx-auto border border-accent text-primary font-semibold font-primary flex items-center gap-2">
            ...
            <p className="text-xs">Waiting for Scan...</p>
          </div>
          ...
          <div className="mt-5 px-4 py-2  bg-primary/5 size-fit rounded-full mx-auto border border-accent text-primary font-semibold font-primary flex items-center ml-6 gap-2 opacity-60">
            <AlertTriangle size={18} />

            <p className="text-xs">Keep your phone screen on</p>
          </div>
